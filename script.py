...
def generate_html_dashboard(df):
    ...
    html_content = (
        ...
        "let T=f-new Date(e.toLocaleString('en-US',{timeZone:'America/New_York'}));m.innerText=formatTimeDuration(Math.floor(T/1000)) NY_Clock=1}"
        "}function formatTimeDuration(e){let t=Math.floor(e/3600),n=Math.floor(e%3600/60),s=e%60;return[t.toString().padStart(2,'0'),n.toString().padStart(2,'0'),s.toString().padStart(2,'0')].join(':')}"
